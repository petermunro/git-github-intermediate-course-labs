...
# The network-troubleshooting-guide.md is in
# the lab-appendix-a-resources/ folder in the lab repo.
cp network-troubleshooting-guide.md troubleshooting/network-connectivity.md
```
